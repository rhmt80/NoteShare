...
class CollegeSelectionViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        stackView.addArrangedSubview(interestsLabel)
    }
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            interestsCollectionView.topAnchor.constraint(equalTo: stackView.bottomAnchor, constant: 20),
            ...
            interestsCollectionView.bottomAnchor.constraint(equalTo: continueButton.topAnchor, constant: -20),
    ...
    private func setupCollectionView() {
        ...
        interestsCollectionView.register(InterestCell.self, forCellWithReuseIdentifier: "InterestCell")
    }
