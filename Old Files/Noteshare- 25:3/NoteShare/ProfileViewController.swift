...
class ProfileViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITableViewDelegate, UITableViewDataSource{
    ...
    private func handlePrivacyRowSelection(_ row: Int) {
        ...
        case 0:
            ...
            - User Content: Notes, images, and other materials you upload.
            ...
            - Sync and store notes securely.
            - Enable AI-based features like summaries, flashcards, and quizzes.
            - Maintain security and prevent fraud.

            3. Sharing and Disclosure
            We do not sell your data. However, we may share your information:
            - With service providers for cloud storage and AI processing.
            - If required by law or to protect our rights.

            4. Data Security
            We implement encryption and security measures to protect your data. However, no system is completely secure, and we encourage users to keep their login credentials safe.
            ...
            We may update this Privacy Policy from time to time. Continued use of the App after updates signifies your acceptance.
        ...
        case 2:
            ...
            1. Use of the App
            - You must be at least 13 years old to use NoteShare.
            - You are responsible for your content and must ensure it does not violate laws or rights of others.
            ...
            - You retain ownership of your uploaded notes and materials.
            - By using AI-powered features, you grant us a license to process your content for functionality purposes.
            - The App and its design, features, and branding belong to NoteShare and cannot be copied without permission.
            ...
            We are not liable for any loss of data, financial loss, or damages resulting from your use of the App. The App is provided "as is" without warranties.
