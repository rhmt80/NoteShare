...
class NoteCollectionViewCell1: UICollectionViewCell {
    ...
    private func setupUI() {
        ...
        containerView.addSubview(whiteBorderView)
        whiteBorderView.addSubview(bookBackgroundView)
        ...
        layer.cornerRadius = 8.0  // For slightly rounded edges
        layer.masksToBounds = true

        // Optional: Add subtle shadow for a more refined look
        layer.shadowColor = UIColor.black.cgColor
        layer.shadowOpacity = 0.1
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            // White Border View
            whiteBorderView.topAnchor.constraint(equalTo: containerView.topAnchor),
            whiteBorderView.leadingAnchor.constraint(equalTo: containerView.leadingAnchor),
            whiteBorderView.trailingAnchor.constraint(equalTo: containerView.trailingAnchor),
            whiteBorderView.bottomAnchor.constraint(equalTo: containerView.bottomAnchor),
            
            // Book Background View
            bookBackgroundView.topAnchor.constraint(equalTo: whiteBorderView.topAnchor, constant: 1),
            bookBackgroundView.leadingAnchor.constraint(equalTo: whiteBorderView.leadingAnchor, constant: 1),
            bookBackgroundView.trailingAnchor.constraint(equalTo: whiteBorderView.trailingAnchor, constant: -1),
            bookBackgroundView.bottomAnchor.constraint(equalTo: whiteBorderView.bottomAnchor, constant: -1),
            ...
            // User Name Label (Positioned at the bottom)
    ...
    func configure(with note: SavedFireNote) {
        ...
        // Only set the color if it hasn't been set yet
        if currentColor == nil {
...
class SavedViewController: UIViewController, UIScrollViewDelegate, UITableViewDelegate, UITableViewDataSource, VNDocumentCameraViewControllerDelegate {
    ...
    private let uploadNotesButton: UIButton = {
        ...
        button.backgroundColor = UIColor(red: 0.9, green: 0.95, blue: 1.0, alpha: 1.0) // Light blue background
