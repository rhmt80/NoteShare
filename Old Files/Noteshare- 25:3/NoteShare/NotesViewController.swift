...
class NotesViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        // Load visited subjects from UserDefaults
        loadVisitedSubjects()
    }
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        // Refresh the UI to update visited states
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Remove chevron and any other indicators
        cell.configureAsUnvisited()
