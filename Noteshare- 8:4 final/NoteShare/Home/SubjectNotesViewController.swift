...
class SubjectNotesViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    private var PlaceholderView1: PlaceholderView1?
    ...
    private func setupPlaceholder() {
        PlaceholderView1 = NoteShare.PlaceholderView1(
        ...
        PlaceholderView1?.backgroundColor = .systemBackground
        PlaceholderView1?.alpha = 1.0
        collectionView.backgroundView = PlaceholderView1
        
        PlaceholderView1?.layer.borderWidth = 0
        PlaceholderView1?.layer.borderColor = UIColor.systemGray5.cgColor
        PlaceholderView1?.layer.cornerRadius = 16
    ...
    private func updatePlaceholderVisibility() {
        DispatchQueue.main.async {
            if self.notes.isEmpty {
                self.PlaceholderView1?.alpha = 1.0
                self.PlaceholderView1?.isHidden = false
            } else {
                UIView.animate(withDuration: 0.3) {
                    self.PlaceholderView1?.alpha = 0.0
                } completion: { _ in
...
//            userId: note.userId ?? "", // Adjust based on your FireNote properties
//            pdfUrl: note.pdfUrl,
