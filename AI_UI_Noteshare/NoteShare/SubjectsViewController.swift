...
class SubjectsViewController: UIViewController {
    ...
    private lazy var subjectData: [Subject] = [
        Subject(title: "Artificial Intelligence", subtitle: "Machine Learning", image: UIImage(named: "Ai_logo") ?? UIImage(), pdfURL: Bundle.main.url(forResource: "test1", withExtension: "pdf")!),
        Subject(title: "Regression", subtitle: "Linear Regression, Logical Regression", image: UIImage(named: "automata_icon") ?? UIImage(), pdfURL: Bundle.main.url(forResource: "test2", withExtension: "pdf")!),
        Subject(title: "Computer Vision", subtitle: "Image Processing", image: UIImage(named: "ml_cover") ?? UIImage(), pdfURL: Bundle.main.url(forResource: "test3", withExtension: "pdf")!),
        Subject(title: "Deep Learning", subtitle: "Neural Networks", image: UIImage(named: "Ai_logo") ?? UIImage(), pdfURL: Bundle.main.url(forResource: "test4", withExtension: "pdf")!),
       
        Subject(title: "LLMs", subtitle: "Netsuite, OpenAI", image: UIImage(named: "automata_icon") ?? UIImage(), pdfURL: Bundle.main.url(forResource: "test5", withExtension: "pdf")!),
        Subject(title: "CNN", subtitle: "ReLU Layer, Pooling Layer", image: UIImage(named: "ml_cover") ?? UIImage(), pdfURL: Bundle.main.url(forResource: "test6", withExtension: "pdf")!)
    ]
