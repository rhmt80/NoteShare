...
class CollectionSubjectViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    private func setupUI() {
        ...
        collectionView.register(CNoteCells.self, forCellWithReuseIdentifier: "CNoteCells")
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "CNoteCells", for: indexPath) as! CNoteCells
...
class CNoteCells: UICollectionViewCell {
