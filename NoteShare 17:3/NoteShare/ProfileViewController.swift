...
class ProfileViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITableViewDelegate, UITableViewDataSource{
    ...
    private func configurePrivacyCell(_ cell: UITableViewCell, forRow row: Int) {
        ...
        switch row {
        case 0:
            label.text = "See how your data is managed"
        case 1:
            label.text = "Help"
        case 2:
    ...
    private func handlePrivacyRowSelection(_ row: Int) {
        ...
        case 0:
            ...
            NoteShare is committed to protecting your privacy and maintaining the security of your personal information. We collect only the necessary data to provide you with a seamless educational content sharing experience:

            * **Account Information**: Your name, email address, and educational institution details
            * **Educational Profile**: Course details and academic interests
            * **Content**: Notes and materials you choose to share
            * **Usage Data**: Information about how you interact with the application

            ## Secure Storage

            All user data is securely stored on Firebase's cloud infrastructure with industry-standard encryption protocols. Profile images are stored in Firebase Storage with appropriate access controls.

            ## Information Sharing

            * Your basic profile (name and educational details) is visible to other NoteShare users
            * Shared notes are accessible based on your chosen sharing permissions
            ...
            * Manage your content sharing preferences within the application

            For additional information about our data handling practices, please contact our privacy team at privacy@noteshare.com.
            """
            navigationController?.pushViewController(dataManagementVC, animated: true)
        ...
        case 1:
            ...
            * **Finding Content**: Browse by category or use the search function for specific topics
            * **Sharing Notes**: Upload and manage your educational materials with flexible sharing options

            ## Troubleshooting

            * **Account Access**: Reset your password via the login screen
            * **Upload Issues**: Ensure your internet connection is stable and file formats are supported
            * **Content Visibility**: Check your sharing permissions if others cannot access your notes
            ...
            * **Support Hours**: 9:00 AM - 6:00 PM EST

            We're committed to providing you with the best possible experience using NoteShare.
            """
        ...
        case 2:
            ...
            By accessing or using NoteShare, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you disagree with any part of these terms, you may not use our services.
            ...
            * Users retain ownership of content they upload to NoteShare
            * By uploading content, you grant NoteShare a non-exclusive license to store, display, and distribute your content as necessary to provide the service
            * You must not upload content that infringes upon intellectual property rights of others
            ...
            * Posting of unlawful, defamatory, or harassing content
            * Any activity that disrupts or impairs the proper functioning of the service

            ## 5. Limitation of Liability

            NoteShare is provided on an "as is" and "as available" basis. We disclaim all warranties of any kind, whether express or implied, including but not limited to fitness for a particular purpose and non-infringement.
            ...
            We may revise these terms at any time. Your continued use of NoteShare following any changes constitutes acceptance of the revised terms.
