...
struct StudyMaterial {
    ...
    init(subjectName: String, courseDescription: String, imageName: String, pdfURL: URL, documentId: String = "") {
...
extension AcademicResourcesViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        // Use document ID if available, otherwise fall back to URL-based initialization
        if !selectedSubject.documentId.isEmpty {
            let pdfViewerVC = PDFViewerViewController(documentId: selectedSubject.documentId)
